    ...
    export class Region{
        ...
        private networkToString(network:NetworkType):string{
            var value: string;
            switch(network){
                case NetworkType.Public:    value = "";               break;
                case NetworkType.Internal:  value = "-internal";      break;
                case NetworkType.VPC:       value = "-internal-vpc";  break;
        ...
        private zoneToString(zone:Zone):string{
            var value:string;
            switch(zone){
                case Zone.China:        value = "cn"; break;
                case Zone.AsiaPacific:  value = "ap"; break;
                case Zone.UniteState:   value = "us"; break;
                case Zone.Europe:       value = "eu"; break;
                case Zone.MiddleEast:   value = "me"; break;
        ...
        private cityToString(city:City):string{
            var value:string;
            switch(city){
                case City.Beijing:      value = "beijing";      break;
                case City.Shanghai:     value = "shanghai";     break;
                case City.Qingdao:      value = "qingdao";      break;
                case City.Hangzhou:     value = "hangzhou";     break;
                case City.Shenzhen:     value = "shenzhen";     break;

                case City.Hongkong:     value = "hongkong";     break;

                case City.Tokyo:        value = "northeast-1";  break;
                case City.Singapore:    value = "southeast-1";  break;
                case City.Sydney:       value = "southeast-2";  break;

                case City.Frankfurt:    value = "central-1";    break;

                case City.SiliconValley:value = "west-1";       break;
                case City.Virginia:     value = "east-1";       break;

                case City.Dubai:        value = "east-1";       break;
